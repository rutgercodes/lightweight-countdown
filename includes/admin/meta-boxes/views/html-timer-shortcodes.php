...
<div class="panel-wrap lwcd_submit_timer">
	...
	<code>[lwcd_timer id="<?php echo esc_html( $thepostid ); ?>"]</code>

	<h4><?php esc_html_e( 'Conditional content before deadline', 'lightweight-countdown' ); ?></h4>
	<code>[lwcd_before_timer id="<?php echo esc_html( $thepostid );  ?>"] <?php esc_html_e( 'This only shows before the deadline', 'lightweight-countdown' ); ?> [/lwcd-timer-before]</code>

	<h4><?php esc_html_e( 'Conditional content after deadline', 'lightweight-countdown' ); ?></h4>
	<code>[lwcd_after_timer id="<?php echo esc_html( $thepostid ); ?>"] <?php esc_html_e( 'This only shows after the deadline', 'lightweight-countdown' ); ?> [/lwcd-timer-before]</code>
